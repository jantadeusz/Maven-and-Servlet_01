...
// zmodyfikowana metoda o Mape
// useSSL=false& - na ten fragment musisz uwazac bo wywala blad
...
public class DbService {
    ...
    private static Connection createConn() throws SQLException, ClassNotFoundException {
        ...
        String connUrl = "jdbc:mysql://localhost:3306/" + dbName + "?allowMultiQueries=true&useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&autoReconnect=true";
        return DriverManager.getConnection(connUrl, dbUser, dbPass);
    }
